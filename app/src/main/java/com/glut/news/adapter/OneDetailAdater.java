...
public class OneDetailAdater extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<Comments.CommentsDataList> commentsList;
    private Context c;

    private View VIEW_FOOTER;
    private View VIEW_HEADER;

    public OneDetailAdater(Context context, List<Comments.CommentsDataList> commentsList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (!isHeaderView(position) && !isFooterView(position)) {
            ...
            Glide.with(c).load(commentsList.get(position).getUser().getWeb_url()).transform(new CircleImage(c)).into(((OneDetailViewHolder) holder).mAuthor_logo);
    ...
    public void changeData(List<Comments.CommentsDataList> data) {
        commentsList = data;
