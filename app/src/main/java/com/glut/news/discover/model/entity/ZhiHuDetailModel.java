 ...
 */
public class ZhiHuDetailModel implements Parcelable{
    private String body;
    ...
    protected ZhiHuDetailModel(Parcel in) {
        body = in.readString();
    ...
    public static final Creator<ZhiHuDetailModel> CREATOR = new Creator<ZhiHuDetailModel>() {
        @Override
        public ZhiHuDetailModel createFromParcel(Parcel in) {
            return new ZhiHuDetailModel(in);
        }

        @Override
        public ZhiHuDetailModel[] newArray(int size) {
            return new ZhiHuDetailModel[size];
        }
    };
