...
public class ZhiHuAdater extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    private Context c;
    private List<ZhiHuNewsModel> zhiHuLists;
    ...
    public ZhiHuAdater(Context context, List<ZhiHuNewsModel> zhiHuList) {
        this.c=context;
    ...
    public void addData(List<ZhiHuNewsModel> z){
        if (zhiHuLists==null){
            changeData(z);
        }else{
            zhiHuLists.addAll(z);
    ...
    public void changeData(List<ZhiHuNewsModel> z){
        zhiHuLists=z;
        notifyDataSetChanged();
    }
    @Override
