...
public class GuoKrAdater extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    private List<GuoKrListModel.GuokrHandpickNewsResult> guoKrList;
private LayoutInflater l;
    private Context c;
    private OnItemClickListener mOnItemClickListener;
    public GuoKrAdater(Context c,List<GuoKrListModel.GuokrHandpickNewsResult> guoKrList){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        Glide.with(c).load(guoKrList.get(position).getAuthor().getAvatar().getSmall()).apply(
        RequestOptions.circleCropTransform()).into(((GuoKrViewHolder)holder).author_logo);
    }
    ...
    public void changeData(List<GuoKrListModel.GuokrHandpickNewsResult> guoKrList) {
        this.guoKrList=guoKrList;
    ...
    public void addData(List<GuoKrListModel.GuokrHandpickNewsResult> guoKrList) {
