...
public class GuoKrFragment extends android.support.v4.app.Fragment implements PullToRefreshView.OnRefreshListener {
    ...
    private List<GuoKrList.GuokrHandpickNewsResult> guoKrList = new ArrayList<>();
    ...
    public void loadDta() {
        ...
        RetrofitManager.builder(RetrofitService.GUOKR_HANDPICK_BASE,"GuoKrService").getLatestNews1()
                ...
                .map(new Func1<GuoKrList, GuoKrList>() {
                    @Override
                    public GuoKrList call(GuoKrList guoKrList) {
                        return guoKrList;
                    }
                })
                .subscribe(new Action1<GuoKrList>() {
                    @Override
                    public void call(GuoKrList guoKrList) {
                        mPbLoading.setVisibility(View.GONE);
                        if (guoKrList==null){
                            mTvLoadEmpty.setVisibility(View.VISIBLE);
                        }else{

                            guoKrAdater.changeData(guoKrList.getResult());
                ...
                .subscribe(new Action1<ZhiHuList>() {
                    ...
                    public void call(ZhiHuList zhiHuList) {
                        ...
                        if (zhiHuList==null){
                            ...
                            for (ZhiHuNews z:zhiHuList.getStories()){
