...
public class KaiYanFragment extends Fragment implements PullToRefreshView.OnRefreshListener {
    ...
    private List<KaiYan.KaiYanList> kaiYanList = new ArrayList<>();
    ...
    public void loadDta() {
        ...
        RetrofitManager.builder(RetrofitService.KAIYAB_BASE_URL,"KaiYanService").getLatestNews3()
                ...
                .map(new Func1<KaiYan, KaiYan>() {
                    @Override
                    public KaiYan call(KaiYan kaiYan) {
                        return kaiYan;
                    }
                })
                .subscribe(new Action1<KaiYan>() {
                    @Override
                    public void call(KaiYan kaiYan) {
                        mPbLoading.setVisibility(View.GONE);
                        if (kaiYan==null){
                            mTvLoadEmpty.setVisibility(View.VISIBLE);
                        }else{

                            nextPage=kaiYan.getNextPageUrl().substring(55,kaiYan.getNextPageUrl().length()-7);

                            kaiYanAdater.changeData(kaiYan.getItemList());
                ...
                .subscribe(new Action1<KaiYan>() {
                    ...
                    public void call(KaiYan kaiYan) {
                        ...
                        if (kaiYan==null){
                            ...
                            kaiYanAdater.addData(kaiYan.getItemList());
                            mTvLoadEmpty.setVisibility(View.GONE);
                        }
